...
#
# pkg:gem/htmlentities#lib/htmlentities/flavors.rb:1
class HTMLEntities
  ...
  #
  # pkg:gem/htmlentities#lib/htmlentities.rb:32
  ...
  #
  # pkg:gem/htmlentities#lib/htmlentities.rb:43
  ...
  #
  # pkg:gem/htmlentities#lib/htmlentities.rb:72
  def encode(source, *instructions); end
end

# pkg:gem/htmlentities#lib/htmlentities/decoder.rb:2
class HTMLEntities::Decoder
  # pkg:gem/htmlentities#lib/htmlentities/decoder.rb:3
  def initialize(flavor); end

  # pkg:gem/htmlentities#lib/htmlentities/decoder.rb:9
  def decode(source); end

  private

  # pkg:gem/htmlentities#lib/htmlentities/decoder.rb:28
  def entity_regexp; end

  # pkg:gem/htmlentities#lib/htmlentities/decoder.rb:24
  def prepare(string); end
end

# pkg:gem/htmlentities#lib/htmlentities/encoder.rb:4
class HTMLEntities::Encoder
  # pkg:gem/htmlentities#lib/htmlentities/encoder.rb:7
  def initialize(flavor, instructions); end

  # pkg:gem/htmlentities#lib/htmlentities/encoder.rb:15
  def encode(source); end

  private

  # pkg:gem/htmlentities#lib/htmlentities/encoder.rb:40
  def basic_entity_regexp; end

  # pkg:gem/htmlentities#lib/htmlentities/encoder.rb:73
  def build_basic_entity_encoder(instructions); end

  # pkg:gem/htmlentities#lib/htmlentities/encoder.rb:88
  def build_extended_entity_encoder(instructions); end

  # pkg:gem/htmlentities#lib/htmlentities/encoder.rb:36
  def contains_only_ascii?(string); end

  # pkg:gem/htmlentities#lib/htmlentities/encoder.rb:106
  def encode_decimal(char); end

  # pkg:gem/htmlentities#lib/htmlentities/encoder.rb:110
  def encode_hexadecimal(char); end

  # pkg:gem/htmlentities#lib/htmlentities/encoder.rb:101
  def encode_named(char); end

  # pkg:gem/htmlentities#lib/htmlentities/encoder.rb:44
  def extended_entity_regexp; end

  # pkg:gem/htmlentities#lib/htmlentities/encoder.rb:28
  def minimize_encoding(string); end

  # pkg:gem/htmlentities#lib/htmlentities/encoder.rb:24
  def prepare(string); end

  # pkg:gem/htmlentities#lib/htmlentities/encoder.rb:52
  def replace_basic(string); end

  # pkg:gem/htmlentities#lib/htmlentities/encoder.rb:56
  def replace_extended(string); end

  # pkg:gem/htmlentities#lib/htmlentities/encoder.rb:114
  def reverse_map; end

  # pkg:gem/htmlentities#lib/htmlentities/encoder.rb:60
  def validate_instructions(instructions); end
end

# pkg:gem/htmlentities#lib/htmlentities/encoder.rb:5
HTMLEntities::Encoder::INSTRUCTIONS = T.let(T.unsafe(nil), Array)

# pkg:gem/htmlentities#lib/htmlentities/flavors.rb:2
HTMLEntities::FLAVORS = T.let(T.unsafe(nil), Array)

# pkg:gem/htmlentities#lib/htmlentities/encoder.rb:2
class HTMLEntities::InstructionError < ::RuntimeError; end

# pkg:gem/htmlentities#lib/htmlentities/flavors.rb:3
HTMLEntities::MAPPINGS = T.let(T.unsafe(nil), Hash)

# pkg:gem/htmlentities#lib/htmlentities/flavors.rb:4
HTMLEntities::SKIP_DUP_ENCODINGS = T.let(T.unsafe(nil), Hash)

# pkg:gem/htmlentities#lib/htmlentities.rb:11
class HTMLEntities::UnknownFlavor < ::RuntimeError; end

# pkg:gem/htmlentities#lib/htmlentities/version.rb:2
module HTMLEntities::VERSION; end

# pkg:gem/htmlentities#lib/htmlentities/version.rb:3
HTMLEntities::VERSION::MAJOR = T.let(T.unsafe(nil), Integer)

# pkg:gem/htmlentities#lib/htmlentities/version.rb:4
HTMLEntities::VERSION::MINOR = T.let(T.unsafe(nil), Integer)

# pkg:gem/htmlentities#lib/htmlentities/version.rb:7
HTMLEntities::VERSION::STRING = T.let(T.unsafe(nil), String)

# pkg:gem/htmlentities#lib/htmlentities/version.rb:5
