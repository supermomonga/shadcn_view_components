...
# pkg:gem/rubocop-packaging#lib/rubocop/packaging/version.rb:3
module RuboCop; end

# pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/bundler_setup_in_tests.rb:6
module RuboCop::Cop; end

# pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/bundler_setup_in_tests.rb:7
...
#   require "foo"
#
# pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/bundler_setup_in_tests.rb:20
class RuboCop::Cop::Packaging::BundlerSetupInTests < ::RuboCop::Cop::Base
  ...
  #
  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/bundler_setup_in_tests.rb:57
  def autocorrect(corrector, node); end

  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/bundler_setup_in_tests.rb:29
  ...
  #
  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/bundler_setup_in_tests.rb:66
  def bundler_setup_in_test_dir?(str); end

  # This method determines if the call is made *from* the tests directory.
  #
  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/bundler_setup_in_tests.rb:71
  ...
  #
  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/bundler_setup_in_tests.rb:39
  ...
  #
  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/bundler_setup_in_tests.rb:47
...
#
# pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/bundler_setup_in_tests.rb:27
...
#   end
#
# pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/gemspec_git.rb:48
class RuboCop::Cop::Packaging::GemspecGit < ::RuboCop::Cop::Base
  ...
  # Processing of the AST happens here.
  #
  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/gemspec_git.rb:70
  def on_new_investigation; end

  # This method is called from inside `#def_node_search`.
  # It is used to find strings which start with "git".
  #
  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/gemspec_git.rb:83
  def starts_with_git?(str); end

  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/gemspec_git.rb:56
  def xstr(param0); end
end
...
#
# pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/gemspec_git.rb:51
...
#   require "baz/qux"
#
# pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/require_hardcoding_lib.rb:37
class RuboCop::Cop::Packaging::RequireHardcodingLib < ::RuboCop::Cop::Base
  ...
  #
  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/require_hardcoding_lib.rb:85
  ...
  #
  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/require_hardcoding_lib.rb:93
  ...
  #
  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/require_hardcoding_lib.rb:100
  ...
  #
  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/require_hardcoding_lib.rb:77
  ...
  # Processing of the AST happens here.
  #
  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/require_hardcoding_lib.rb:59
  def on_new_investigation; end
  ...
  # https://github.com/rubocop-hq/rubocop-ast/blob/08d0f49a47af1e9a30a6d8f67533ba793c843d67/lib/rubocop/ast/traversal.rb#L112
  #
  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/require_hardcoding_lib.rb:67
  def on_send(node); end

  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/require_hardcoding_lib.rb:46
...
#
# pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/require_hardcoding_lib.rb:43
...
#
# pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/require_relative_hardcoding_lib.rb:30
class RuboCop::Cop::Packaging::RequireRelativeHardcodingLib < ::RuboCop::Cop::Base
  ...
  #
  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/require_relative_hardcoding_lib.rb:75
  def falls_in_lib?(str); end

  # Called from on_send, this method helps to replace the
  # "bad" require_relative call with the "good" one.
  #
  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/require_relative_hardcoding_lib.rb:67
  def good_require_call; end
  ...
  # Processing of the AST happens here.
  #
  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/require_relative_hardcoding_lib.rb:49
  def on_new_investigation; end
  ...
  # https://github.com/rubocop-hq/rubocop-ast/blob/08d0f49a47af1e9a30a6d8f67533ba793c843d67/lib/rubocop/ast/traversal.rb#L112
  #
  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/require_relative_hardcoding_lib.rb:57
  def on_send(node); end

  # pkg:gem/rubocop-packaging#lib/rubocop/cop/packaging/require_relative_hardcoding_lib.rb:39
...
module RuboCop::Packaging::LibHelperModule
  ...
  #
  # pkg:gem/rubocop-packaging#lib/rubocop/packaging/lib_helper_module.rb:20
  def target_falls_in_lib_using_file?(str); end
end

# A plugin that integrates RuboCop Packaging with RuboCop's plugin system.
#
# pkg:gem/rubocop-packaging#lib/rubocop/packaging/plugin.rb:8
class RuboCop::Packaging::Plugin < ::LintRoller::Plugin
  # pkg:gem/rubocop-packaging#lib/rubocop/packaging/plugin.rb:9
  def about; end

  # pkg:gem/rubocop-packaging#lib/rubocop/packaging/plugin.rb:22
  def rules(_context); end

  # pkg:gem/rubocop-packaging#lib/rubocop/packaging/plugin.rb:18
  def supported?(context); end
end

# pkg:gem/rubocop-packaging#lib/rubocop/packaging/version.rb:5
