...
| [`Shadcn::ContextMenu::Item`](../../../app/components/shadcn/context_menu.rb#L44) | `new(variant: nil, **args)`<br>initializerはShadcn::DropdownMenu::Itemで定義 | variant: default, destructive (default: "default") | `context-menu-item` |
...
| [`Shadcn::ContextMenu::SubTrigger`](../../../app/components/shadcn/context_menu.rb#L70) | `new(variant: nil, **args)`<br>initializerはShadcn::DropdownMenu::Itemで定義 | 追加制約なし（signatureどおり） | `context-menu-sub-trigger` |
