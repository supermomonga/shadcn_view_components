...
- 関連ドキュメント: [00-overview](00-overview.md) / [01-architecture](01-architecture.md) / [04-component-conventions](04-component-conventions.md) / [09-ci-drift-detection](09-ci-drift-detection.md)
...
| 生成物 | 抽出器が生成するRubyにもsigを注入（[03](03-extraction-codegen.md) §6.1）。生成物で型エラーが出たら抽出器のバグ |
...
### 3.1 標準形（[04](04-component-conventions.md) §7 と同一）
...
module Shadcn
  class BaseComponent < ViewComponent::Base
    ...
    # 契約に存在しない値 → ArgumentError（[01](01-architecture.md) §6.1）
  end
end
```
...
- erbsorbet（ERB内型検査）は**導入しない**（決定 #4の補足。[04](04-component-conventions.md) §2）。
...
[03-extraction-codegen](03-extraction-codegen.md) §6.1 の生成Rubyは:
