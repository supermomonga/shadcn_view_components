...
- 意味上の仕様: [docs/component_reference/accordion-dialog.yml](../component_reference/accordion-dialog.yml)、[docs/component_reference/direction-pagination.yml](../component_reference/direction-pagination.yml)、[docs/component_reference/popover-tooltip.yml](../component_reference/popover-tooltip.yml)
