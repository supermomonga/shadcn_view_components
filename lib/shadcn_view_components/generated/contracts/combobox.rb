...
# Source: shadcn/ui new-york-v4 "combobox" (item sha256: ad1cbc787d29f04548658e51a1d19f6d7e949f8e9732df75e426715b3d81c8b6)
  ...
  module Contracts
    module Combobox
      ...
      SLOTS = T.let([
        ...
        { name: "input-group-button", tag: "InputGroupButton", static_attributes: { class: "group-has-data-[slot=combobox-clear]/input-group:hidden data-pressed:bg-transparent" }.freeze, dynamic_attributes: ["disabled"].freeze }.freeze
      ].freeze, T::Array[T::Hash[Symbol, T.untyped]])
      ...
      SLOTS = T.let([
        ...
        { name: "combobox-item-indicator", tag: "ComboboxPrimitive.ItemIndicator", static_attributes: {}.freeze, dynamic_attributes: ["render"].freeze }.freeze
      ].freeze, T::Array[T::Hash[Symbol, T.untyped]])
      ...
      SLOTS = T.let([
        ...
        { name: "combobox-trigger-icon", tag: "ChevronDownIcon", static_attributes: { class: "pointer-events-none size-4 text-muted-foreground" }.freeze, dynamic_attributes: [].freeze }.freeze
      ].freeze, T::Array[T::Hash[Symbol, T.untyped]])
