...
# Source: shadcn/ui new-york-v4 "input" (item sha256: c223f134568a391206024d83f8b35e93671e4e7e782b8ea5f9a4b518236b8f9e)
...
module ShadcnViewComponents
  module Contracts
    module Input
      ...
      SLOTS = T.let([
        { name: "input", tag: "input", static_attributes: {}.freeze, dynamic_attributes: ["type"].freeze }.freeze
